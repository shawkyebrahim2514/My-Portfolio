...
const categories = [
  ...
  {
    _id: 'hubCategory-money',
    _type: 'hubCategory',
    title: 'Money',
    slug: { _type: 'slug', current: 'money' },
    description: 'Investing and everyday personal finance.',
    accentColor: 'base',
    order: 4,
  },
  {
    _id: 'hubCategory-english',
    _type: 'hubCategory',
    title: 'English',
    slug: { _type: 'slug', current: 'english' },
    description: 'Learning English — shows, speech, and lessons.',
    accentColor: 'secondary',
    order: 5,
  },
  {
    _id: 'hubCategory-hardware',
    _type: 'hubCategory',
    title: 'Hardware',
  ...
  {
    _id: 'hubCategory-curiosity',
    _type: 'hubCategory',
    title: 'Curiosity',
    slug: { _type: 'slug', current: 'curiosity' },
